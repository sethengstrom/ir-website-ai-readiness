    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <main id="main-content" className="max-w-3xl mx-auto px-4 py-8 space-y-10" tabIndex={-1}>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[var(--muted)] text-sm space-y-1 ml-2">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[var(--muted)] text-sm space-y-1 ml-2 mb-3">
          ...
          <p className="text-[var(--muted)] text-sm mb-2">The 12 questions:</p>
          <ol className="list-decimal list-inside text-[var(--muted)] text-sm space-y-1 ml-2">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[var(--muted)] text-sm space-y-1 ml-2 mb-4">
